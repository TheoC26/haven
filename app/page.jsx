...
export default function Home() {
  ...
  return (
    <div className="w-screen min-h-screen bg-[#B3DAAA] overflow-hidden">
      ...
      <div className="absolute w-full md:max-w-2xl text-5xl scale-95 text-black text-center left-1/2 -translate-x-1/2 font-bold top-[700px] md:top-[1120px]">
      ...
      <section className="max-w-screen-2xl min-w-screen absolute left-1/2 -translate-x-1/2 font-bold top-[1600px] md:top-[2300px]">
        <div className="text-center text-4xl text-black">Our clubs</div>
